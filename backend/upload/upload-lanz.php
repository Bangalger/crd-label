<?php
	...
	function subir_imagen($file){
		...
		if($file && $file["name"]!=""){
			...
			$direccion_web = "http://crd-label.com.ar/backend/upload/img/lanzamientos/";
			$nombre_carpeta = "img/lanzamientos/";
	...
	if(isset($_POST["submit"])){
		...
		echo "recibi". $nombre_lanzamiento;
		$nombre_lanzamiento = mysqli_real_escape_string($conexion,$_POST["nombre_lanzamiento"]);
		echo "recibi". $nombre_lanzamiento;
		//$campo1 = mysqli_real_escape_string($conexion,$_POST["campo1"]);
		$link_soundcloud = mysqli_real_escape_string($conexion,$_POST["link_soundcloud"]);
		echo "recibi". $link_soundcloud;
		//$campo2 = mysqli_real_escape_string($conexion,$_POST["campo2"]);
		$link_btn_venta = mysqli_real_escape_string($conexion,$_POST["link_btn_venta"]);
		echo "recibi". $link_btn_venta;
		...
		//if($imagen=="error"){
			...
			echo '<a href="formulario-lanzamiento.php">Volver atras</a>';
			...
			$sql = "INSERT INTO lanzamientos (imagen, nombre_artista, nombre_lanzamiento, link_souncloud, link_btn_venta) values ('$imagen','$nombre_artista','$nombre_lanzamiento','$link_soundcloud','$link_btn_venta')";

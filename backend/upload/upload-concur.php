...
/*___________________ funcion subir archivo no sirve aun, preguntar a gaston _____________________________
	function subir_archivo($file){
		...
		if($file && $file["name"]!=""){
			...
			// DEFINO CUÁL VA A SER LA URL DE MI SITIO WEB, Y LA CARPETA DONDE SE GUARDARÁN LAS IMÁGENES (ESTO DEBERÍA ESTAR EN UN ARCHIVO EXTERNO DE CONFIGURACIÓN)
			$direccion_web = "http://localhost/crd_label_nuevo/backend/upload/img/artistas/";
...
*/
	...
	if(isset($_POST["submit"])){
		...
		//if($imagen=="error"){
			...
			$sql = "insert into concursos (titulo, imagen, archivos, texto, descripcion) values ('$titulo','$imagen','$archivos','$texto','$descripcion')";
